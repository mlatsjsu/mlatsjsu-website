...
DROP SEQUENCE IF EXISTS spotlights_seq, board_seq, projects_seq, learning_resources_seq CASCADE;
DROP TABLE IF EXISTS whitelist, spotlights, board, projects, learning_resources CASCADE;
